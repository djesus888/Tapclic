...
private function in_progress($auth)
{
    ...
    if ($updated && $request) {
        ...
        // (Opcional) también avisar al mismo provider
        $this->emitWs([
            'receiver_id'   => $auth->id,
            'receiver_role' => 'provider',
